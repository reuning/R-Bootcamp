...
[Download this data](images/disability_comp.csv) and we are going to open it in R. It has data on the number veterans in each county recieving disability benefits. 

## Importing Data with RStudio

 - In the bottom right you can look through files, it shows the **working directory**. 
 - You can change the **working directory** by going to Session $\rightarrow$ Set Working Directory $\rightarrow$ Choose Director\...
...
setwd("~/Dropbox/Teaching_Kevin/Spring_2023/R Bootcamp/images") # Set working directory 
...
Pick two numeric variables and calculcate the mean, median and standard deviation for them. 
...
Total number of male receipents:
```{R}
