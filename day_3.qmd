...
ggplot(df, 
    ...
    labs(y="Frequency", x="Acaddemic Freedom (V-Dem)", 
...
Each aesthetics has associated functions that can be used to modify the `scale` it uses. For example: `scale_color_gradient()` switches the colors to a gradient defined by a `high` color and a `low` color. 
...
There are a lot of [scales](https://ggplot2.tidyverse.org/reference/index.html#scales) and often their are similar ones that apply to different aesthetics:
...
![](images/gun_violence.jpg){height=80% fig-align="center"}
...
![](images/flipped_2.png){width=100% fig-align="center"}
...
![](images/comparisons_1.png){height=100% fig-align="center"}

## Example: Making it clear 

![](images/comparisons_2.png){width=100% fig-align="center"}
...
![](images/all_posts.png){width=100% fig-align="center"}
