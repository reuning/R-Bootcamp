...
If you want to follow along the Nevada egdelist data is [here](images/network_data/NV-2013-2016-Edges.csv) and the metadata is [here](images/network_data/NV-2013-2016-Meta.csv). 
...
adj_df <- read.csv("images/network_data/IS_BBC_61_IS_BBC-FRIENDS.csv", row.names=1)
...
edge_df <- read.csv("images/network_data/NV-2013-2016-Edges.csv")
...
edge_df <- read.csv("images/network_data/NV-2013-2016-Edges.csv")
meta_df <- read.csv("images/network_data/NV-2013-2016-Meta.csv")
