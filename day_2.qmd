...
-   ggplot is another tidyverse package that is commonly used to make
    plots.

-   It has a somewhat unique way to create plots, but through this you
    can create very custom plots (and easily change them)
:::
...
::: frame
How to Answer Them For ggplot we use different functions to answer them.
...
![image](images/plot_1.png){width=".8\\textwidth"}
:::
